// handle CRUD (Create, Read, Update, Delete) operations on user's and vendor's profile pictures.
...
const deleteDpUser = async (req, res, next) => {
    try {
        ...
        const filesSchema = db.collection(process.env.DB_PROFILE_PIC_COLLECTION + ".files");
        const chunksSchema = db.collection(process.env.DB_PROFILE_PIC_COLLECTION + ".chunks");
...
module.exports = { updateDpUser, updateDpVendor, deleteDpUser, deleteDpVendor, renderDp };